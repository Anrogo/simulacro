package com.simulacro.app.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.simulacro.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.simulacro.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.simulacro.app.domain.Vuelo.class.getName() + ".tripulantes");
            createCache(cm, com.simulacro.app.domain.Avion.class.getName() + ".vuelos");
