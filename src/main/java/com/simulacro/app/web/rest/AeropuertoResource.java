...
import com.simulacro.app.service.AeropuertoQueryService;
import com.simulacro.app.service.AeropuertoService;
...
/**
 * REST controller for managing {@link com.simulacro.app.domain.Aeropuerto}.
 */
@RestController
@RequestMapping("/api")
public class AeropuertoResource {
    ...
    public ResponseEntity<List<AeropuertoDTO>> getAllAeropuertos(
        ...
        Page<AeropuertoDTO> page = aeropuertoQueryService.findByCriteria(criteria, pageable);
