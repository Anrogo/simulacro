...
import com.simulacro.app.service.PilotoQueryService;
import com.simulacro.app.service.PilotoService;
...
/**
 * REST controller for managing {@link com.simulacro.app.domain.Piloto}.
 */
@RestController
@RequestMapping("/api")
public class PilotoResource {
     ...
     */
    @GetMapping("/pilotos")
    public ResponseEntity<List<PilotoDTO>> getAllPilotos(
        PilotoCriteria criteria,
        @org.springdoc.api.annotations.ParameterObject Pageable pageable
    ) {
        log.debug("REST request to get Pilotos by criteria: {}", criteria);
        Page<PilotoDTO> page = pilotoQueryService.findByCriteria(criteria, pageable);
