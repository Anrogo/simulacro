...
describe('Tripulacion Management Component', () => {
  let comp: TripulacionComponent;
  let fixture: ComponentFixture<TripulacionComponent>;
  let service: TripulacionService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'tripulacion', component: TripulacionComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(TripulacionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.tripulacions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
